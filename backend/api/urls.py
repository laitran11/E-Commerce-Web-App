...
urlpatterns = [
    ...
    path('category/<int:pk>/', views.CategoriesDetailView.as_view(), name='category_detail'),
    path('cart/', views.UserCartView.as_view(), name='cart'),
    path('cart-items/<int:pk>/', views.CartItemDetailView.as_view(), name='cart_items'),
    path('category/parent/<str:parent_id>/', views.CategoriesByParentView.as_view(), name='categories_by_parent'),
]